...
class Model(nn.Module):
    ...
    def __init__(self, configs, conv_kernel=[12, 16]):
        ...
        self.dec_embedding = DataEmbedding(configs.enc_in, configs.d_model, configs.embed, configs.freq,
                                           configs.dropout)
        self.dec_embedding1 = DataEmbedding(configs.enc_in, configs.d_model, configs.embed, configs.freq, configs.dropout)
    ...
    def forward(self, x_enc, x_dec, x_mark_dec, is_train=False):
